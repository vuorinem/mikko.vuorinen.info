    ...
    return (
        <div className={styles.history}>
            ...
            <section>
                ...
                <p>
                    Working at Codify and the direct interaction with clients was very rewarding, but over the Moving away from Aberdeen to Edinburgh was the trigger to look 
                </p>
            </section>
