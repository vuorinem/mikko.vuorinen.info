    ...
    return (
        <div className={styles.history}>
            ...
            <section>
                ...
                <p>
                    While working at Codify, I started
            ...
            <section className={styles.caseStudy}>
                ...
                <p>
                    The first version of the e-reader was used in a study where university students read materials assigned to them as part of course work. The texts were adapted to HTML format that could be displayed by the reader in a page-by-page. Before the main data collection phase, a pilot study was conducted with several participants. This was necessary not just for testing the reader itself, but also to ensure the study could be run smoothly and the data collected by the reader containet the necessary information for the analysis. Based on the pilot feedback and observations, some final tweaks were made to the software. In the study, overall about 50 students took part, and the results werer used in writing a Masters dissertation in Psychology.
                </p>
                <p>
                    After successfully applying the e-reader to conduct a study on reading academic materials, it was then modified to support a second study where the topic was <b>recreational reading</b>. This version of the reader had a selection of short stories, and participants were assigned one of them to read based on their answers in a newly added questionnaire. Other features were adapted support the new study as well, and a new pilot phase was done to ensure the quality of user experience and data collection features. The main study included 60 participants using the e-reader over two weeks. As an additional challenge, participants were compensated for completing the required parts of the study, which meant that we had to be able to track the completion while maintaining anonymity of the data collected from each participant.
                </p>
                <p>
                    The third study with the e-reader was in many ways on a different scale. To attract participants, a library of 15 full-length books was obtained by collaborating with publishers of popular authors. Participants could freely select the book they wanted to read using a library feature, which was developed to include data collection features similar to the main reader. Another major addition was a personal infographic page for participants who had read enough in order for the application to generate graphs on their reading process. While my role was only the implementation of the software, all the changes and new requirements were discussed and worked on collaboratively, taking into account the different context of a much larger-scale study.
                </p>
                <p>
