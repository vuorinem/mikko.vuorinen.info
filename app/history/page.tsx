    ...
    return (
        <div className={styles.history}>
            ...
            <section>
                ...
                <p>
                    So far I had lived in a relative safety of my home country, in a relative ease of doing mostly things that I was comfortable with and relatively good at. My growing interest in Japan through anime was pulling me into a different direction. Before I knew it, I was taking Japanese lessons, and with a little push from my big brother I was on a plane on my way to <ExternalLink href="https://www.tohoku.ac.jp/en/">Tohoku University</ExternalLink> in Sendai. [FB: Give more context about the exchange] The year in Japan taught me many things, but most importantly for this story, it taught me to work (and live) with different people. While I didn&apos;t improve much in my programming skills or gain knowledge of the latest features in languages and frameworks, I worked in a signal processing lab where I gave presentations (one in <b>English</b> and one in <b>Japanese</b>), talked daily to people from very different fields and many different countries, learned about Japanese culture with Japanese people and fellow foreigners, experienced being an outsider, and supported each other in the dorm room and class room.
                </p>
                <p>
                    During the time in Japan I also found <ExternalLink href="https://en.wikipedia.org/wiki/Kendo">kendo</ExternalLink> [FB: Explain and expland on kendo, why etc?], which put me in the path of growing myself in a very different way &mdash; in a way that I have found invaluable, and after 16 years of practicing, inseparable part of myself. Explaining how kendo has affected me would be an essay of its own, but some of the most related things include building confidence, coaching others and respecting every encounter.
                </p>
                <p>
