    ...
    return (
        <div className={styles.history}>
            ...
            <section>
                ...
                <p>
                    I spent over five years at Codify, which was all the time I lived in Aberdeen. After the first couple of years I considered switching companies, but I was convinced to stay by giving me responsibilities that were better fit for my interests and goals. The technologies used in earlier projects were mainly built using <b>WPF</b>, <b>WCF</b> and <b>ASP.NET MVC</b>. I started to investigate a <b>SPA</b> framework called <ExternalLink href="https://aurelia.io/">Aurelia</ExternalLink>, and became a major force to drive the adaptation of modern web technologies by building necessary tooling and helping other developers.
                </p>
            </section>
