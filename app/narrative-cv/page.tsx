    ...
    return (
        <div className={styles.narrativeCv}>
            ...
            <section>
                ...
                <p>
                    The first car dealer website I built grew into several websites for sister companies in early 2000&apos;s, with an <b>integration to on-premise sales system</b> (and later an external SaaS offering the company migrated to). Used car stock was displayed in real-time on the website, and the sales staff could use a back-office tool to enrich the online view with details that the on-premise system didn&apos;t support. In addition to the website, I also built an <b>online calendar</b> system in 2004 for arranging meetings, tracking holidays, booking meeting rooms and various other requirements that were discovered along the way. The calendar was in active use for over ten years, and still had some uses after 15 years since its conception, making it my second-longest living online creation. Which brings me to the one in the first place...
                </p>
            </section>
            ...
            <section>
                <p>
                    One of the bigger freelancing projects was <b>kuvapankki.org</b>, which I did for a friend of a friend who was looking for someone to implement their idea of a stock photo gallery for professional photographers. The core functionality was a photo search based on tags that the photographers could set for photos they uploaded to the service. Users could select the photos they wanted to purchase, and send a purchase request. The UI had to be impressive and give a streamlined experience for users, so it was designed together with the client. One of the additional technical challenges was adding a watermark to the images to discourage using them without permission.
                </p>
                <div className={styles.borderedImage}>
                    <Image
                        src={kuvapankki}
            ...
            <section id="casestudy-riskmanagement" className={styles.caseStudy}>
                ...
                <p>
                    There were roughly two types of meetings I had with the client: <b>ideation</b> of a solution for a new requirement, and review of a <b>prototype</b> of previously discussed solution. Ideation was driven by the client as they explained the problem and the solution they had in mind based on their expertice in the field, while I provided concrete suggestions of feasible ways to implement a solution, often using hand-drawn examples of the user interface components. The result of such meeting was usually an agreed plan forwards in a form of screen scetches, bullet points, formulas as well as timelines and budget. I would then go on and work on the application accordingly, often emailing the client to ask for clarifications as the details of the problem revealed themselves during the development.
                </p>
                <p>
