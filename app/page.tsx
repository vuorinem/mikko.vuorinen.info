  ...
  return (
    <div className={styles.home}>
      ...
      <ul className={styles.links}>
        ...
        <li>▸ Take a look at the case studies of <Link href="/history#casestudy-siriusreader">Sirius Reader</Link>, <Link href="/history#casestudy-lahjalista">Lahjalista.net</Link>, <Link href="/history#casestudy-opeka">Opeka</Link> and <Link href="/history#casestudy-riskmanagement">a risk management application</Link></li>
